...
class FineTune(object):
    ...
    def train(self):
        ...
        if self.config['model_type'] == 'gin':
            from models.ginet_finetune_for_Calc_kr import GINet
...
if __name__ == "__main__":
    ...
    config['fine_tune_from'] = '600-512-Sep06_16-08-42' #5 options: 1) 50-32-Sep06_16-16-08 or 2)100-64-Sep06_16-13-22 or 3) 150-128-Sep06_16-10-58 or 4) 300-256-Sep08_11-36-22 or 5)  600-512-Sep06_16-08-42
    config["dataset"]["num_workers"] = 0
    config['dataset']['splitting'] = 'random'
    config['model_type'] = 'gin' 
    config['aug'] = 'subgraph'
    ...
    config["model"]["emb_dim"] = 600 # correlated with the origin trained model, see config['fine_tune_from']
    config["model"]["feat_dim"] = 512 # correlated with the origin trained model, see config['fine_tune_from']
